...
begin
 ...
 //OnClick Cargo los Bancos Dispoibles para garpar .                 <--Revisar Todo
  while not (DataModule1.ADOTarjetas.Eof) do
   Begin
     ComboBox1.Items.Add(DataModule1.ADOTarjetas.Fields[2].text);
     DataModule1.ADOTarjetas.Next;
   End;
   //Hcemos visibles las tarjetas :D tamos en la recta anal, digo final
   if (Combobox1.Text <> '') then  begin
      Label2.Visible:=True;
      ComboBox2.Visible:=True;
      while not (DataModule1.ADOTarjetas.Eof) do
         Begin
           ComboBox2.Items.Add(DataModule1.ADOTarjetas.Fields[1].text);
           DataModule1.ADOTarjetas.Next;
          End;
   end;
end;
