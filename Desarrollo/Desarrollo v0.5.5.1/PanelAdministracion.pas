...
formmodifadmin.Edit2.ReadOnly:=false;
formmodifadmin.Edit3.ReadOnly:=false;
formmodifadmin.Edit4.ReadOnly:=false;
formmodifadmin.Edit5.ReadOnly:=false;
formmodifadmin.Edit6.ReadOnly:=false;
formmodifadmin.edit10.readonly:=false;
...
FormOperacionesCategoria.SpeedButton4.enabled:=false;
FormOperacionesCategoria.SpeedButton2.enabled:=false;
formOperacionesCategoria.edit2.Text:=datamodule1.ADOEtiqueta.FieldByName('nombreEtiqueta').AsString;
FormOperacionesCategoria.showmodal;
end;
