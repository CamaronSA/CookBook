...
Result:=Aux;
  ...
  //*******// Powered by Yisus, root de nacimiento. //*******//
procedure TFormModifAdmin.DateTimePicker1Change(Sender: TObject);
begin
  ...
  if buttonSelected= mrOk then
    ...
    try
      ...
      if (DateTimePicker1.Date<1900) or (DateTimePicker1.Date>Now()) then
        raise EFueraRango.Create('Ingrese correctamente su fecha de nacimiento')
        else
...
begin
  ...
  if buttonSelected= mrOk then
    ...
    try
      ...
      ShowMessage('El Administrador se borró exitosamente');
      end;
    except
...
begin
  ...
  if buttonSelected= mrOk then
    ...
    try
      ...
      DataModule1.ADOAdministrador.FieldByName('Mail').AsString:=Edit10.Text;
      DataModule1.ADOAdministrador.Post;
      ShowMessage('El Administrador se agregó exitosamente');
