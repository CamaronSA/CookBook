...
uses
  ...
  CondicionesDeVenta in 'CondicionesDeVenta.pas' {FormCondicionesDeVenta},
  Ayuda in 'Ayuda.pas' {FormAyuda},
...
begin
  ...
  Application.CreateForm(TFormCondicionesDeVenta, FormCondicionesDeVenta);
